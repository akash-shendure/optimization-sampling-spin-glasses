# vanilla gradient descent on the relaxed smooth surrogate H_tilde(x); optional projection to spins
import numpy as np
...
class GradientDescentOptimizer:
    ...
    def run(
        ...
        for step in range(n_steps + 1):
            elapsed = now() - start
            # nan placeholder when not projecting so trace columns stay consistent
        ...
        # finalize: round x back to discrete spins if requested
